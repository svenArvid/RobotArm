...
class Motor
{
  public:
	// constructor
	Motor(int en_pin, int A1_pin, int A2_pin, int sens_pin, float K_prop=5.5, int K_kick_param=200);			// Use of default parameters
	...
	/* Update pos when positive or negative edge detected. If no edges are detected for some time: reset in_motion */
